    ...
    <a href="dashboard.php" class="brand-link">
      ...
      <span class="brand-text font-weight-light">RestoBook | Dev </span>
    </a>
    <div class="sidebar">
...
<li class="nav-item">
            <a href="#" class="nav-link">
              ...
              <p>Restaurant Subscription
                <i class="right fas fa-angle-left"></i>
              </p>
            </a>
            <ul class="nav nav-treeview" style="display: none;">
              <li class="nav-item">
                <a href="uploadmenu.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Subscribers</p>
                </a>
              </li>
           ...
           <li class="nav-item">
                <a href="managesubscriptions.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
