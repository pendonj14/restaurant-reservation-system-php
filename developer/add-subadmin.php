...
$usertype='1';
$query=mysqli_query($conn,"insert into tbladmin(AdminuserName,AdminName,MobileNumber,Email,Password,UserType ) values('$username','$fname','$mobileno','$email','$password','$usertype')");
if($query){
...
<!-- Sub admin Contact Number---->
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="mobilenumber" name="mobilenumber" placeholder="Enter email" pattern="[0-9]{11}" title="10 numeric characters only" required>
                  </div>
