...
$query=mysqli_query($conn,"update tbldeveloper set AdminName='$fname',MobileNumber='$mobileno',Email='$email' where  ID='$adminid'");
if($query){
...
<?php 
$adminid=intval($_SESSION['aid']);
$query=mysqli_query($conn,"select * from tbldeveloper where  ID='$adminid'");
$cnt=1;
...
<!--  admin Contact Number---->
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="mobilenumber" name="mobilenumber" placeholder="Enter Phone Number"  title="11 numeric characters only" maxlength="12" required value="<?php echo $result['MobileNumber'];?>">
                  </div>
