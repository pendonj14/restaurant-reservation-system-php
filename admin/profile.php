...
$query=mysqli_query($conn,"update tbladmin set AdminName='$fname',MobileNumber='$mobileno',Email='$email' where  ID='$adminid'");
if($query){
...
<!--  admin Contact Number---->
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="mobilenumber" name="mobilenumber" placeholder="Enter Phone Number" title="1 numeric characters only" maxlength="11" required value="<?php echo $result['MobileNumber'];?>">
                  </div>
