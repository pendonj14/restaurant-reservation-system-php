        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
<?php $query=mysqli_query($conn,"select id from tbladmin where UserType=0");
        ...
        <?php endif;?>
          ...
          <div class="col-lg-4 col-6">
            ...
            <div class="small-box bg-primary">
              <div class="inner">
<?php $query1=mysqli_query($conn,"select * from tblbookings");
...
?>
          ...
          <div class="col-lg-4 col-6">
            ...
            <div class="small-box bg-warning">
              <div class="inner">
 <?php $query3=mysqli_query($conn,"select * from tblbookings where (boookingStatus is null || boookingStatus='')");
...
<hr />
          ...
          <div class="col-lg-4 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
<?php $query11=mysqli_query($conn,"select * from tblbookings where (boookingStatus='Accepted')");
...
?>
          ...
          <div class="col-lg-4 col-6">
            ...
            <div class="small-box bg-danger">
              <div class="inner">
<?php $query12=mysqli_query($conn,"select * from tblbookings where (boookingStatus='Rejected')");
