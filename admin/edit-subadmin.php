...
$query=mysqli_query($conn,"update tbladmin set AdminName='$fname',MobileNumber='$mobileno',Email='$email' where UserType=0 and ID='$subadminid'");
if($query){
...
$query=mysqli_query($conn,"select * from tbladmin where UserType=0 and ID='$said'");
$cnt=1;
