            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
<?php $query = mysqli_query($conn, "SELECT tblbookings.*, customer.fullName, customer.email, customer.phone_number
                              FROM tblbookings
                              JOIN customer ON tblbookings.customer_id = customer.customer_id
                              WHERE tblbookings.boookingStatus = 'Accepted'");
$cnt=1;
