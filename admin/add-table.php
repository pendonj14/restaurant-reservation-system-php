...
$query=mysqli_query($conn,"insert into tblrestables(tableNumber,AddedBy) values('$tno','$addedby')");
if($query){
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <!-- left column -->
          <div class="col-md-8" style="transform: translateX(200px); margin-top: 100px">
...
<!--  Table No--->
   <div class="form-group">
                    <label for="exampleInputFullname">Table Name</label>
